 ...
 */
class Version20131008105020 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        $this->addSql("DROP VIEW user_stats");
        $this->addSql("CREATE VIEW user_stats AS SELECT concat(user_id, '_', substr(created,1,10)) as id, user_id, sum(pips) as pips, count(id) as total_signals, substr(created,1,10) as date_created FROM `signal` GROUP BY user_id, date_created;");
    }
