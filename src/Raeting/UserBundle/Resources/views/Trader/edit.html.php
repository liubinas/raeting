...
<? $view['slots']->start('header_row') ?>
    <div class="span5">
        <h2><?=$view['translator']->trans('User')?> <?=$view['translator']->trans('Edit')?></h2>
    </div>
    <nav class="span4">
    ...
    <div class="box">
        <div class="row-fluid">
            <div class="content form-horizontal">
                ...
                <form action="<?= $view['router']->generate('user_update', array('id' => $entity->getId())) ?>" method="post" <?= $view['form']->enctype($form) ?>>
