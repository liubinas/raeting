<form action="<?= $view['router']->generate('signals_create', array('id' => $entity->getId())) ?>?link=<?= $createLink; ?>" method="post" <?= $view['form']->enctype($form) ?> class="form-horizontal">
    <div>
        ...
        <div class="col-md-12 form-group">
            ...
            <div class="input-icon">
                <?= $view['form']->widget($form['open'], array('attr' => array('class' => 'form-control input-width-medium', 'placeholder' => 'ex. 0.0000'))) ?>
            </div>
        </div>
        <div class="col-md-12 form-group">
            <?= $view['form']->label($form['take_profit']) ?>
            <div class="input-icon">
                <?= $view['form']->widget($form['take_profit'], array('attr' => array('class' => 'form-control input-width-medium', 'placeholder' => 'ex. 0.0000'))) ?>
            </div>
        </div>
        <div class="col-md-12 form-group">
            <?= $view['form']->label($form['stop_loss']) ?>
            <div class="input-icon">
                <?= $view['form']->widget($form['stop_loss'], array('attr' => array('class' => 'form-control input-width-medium', 'placeholder' => 'ex. 0.0000'))) ?>
            </div>
        </div>
        <div class="col-md-12 form-group">
